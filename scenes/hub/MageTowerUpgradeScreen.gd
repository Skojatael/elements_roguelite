...
func _ready() -> void:
	...
	_entries = [
		...
		upgrades.get("depth_scaling",     {}).merged({"button": _ds_button, "owned_prop": "is_depth_scaling_unlocked", "purchase": MetaManager.purchase_depth_scaling}),
	]
